...
### 1.8. Variables de conexión a BD externalizadas
...
### 1.9. Clases / rutas clave del flujo ONNX v2
...
```json
{
  ...
  "path": "/api/analisis",
  "fieldErrors": {
    "factura.horasPromedioUso": "horasPromedioUso debe ser al menos 1",
    "factura.tipoInmueble": "tipoInmueble debe ser: monoambiente, departamento o casa"
  }
}
```
...
- El contrato HTTP de eficiencia es **Factura 5+7**; el modelo ONNX v2 consume internamente **6 features** codificadas.
